...
import { Routes, Route, Navigate } from 'react-router-dom'; // Добавил Navigate для редиректа
...
import { UsersPageAsync } from 'pages/UsersPage'; // <--- 1. РАСКОММЕНТИРОВАЛ
